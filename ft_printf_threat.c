...
/*   Updated: 2021/07/06 22:00:37 by sameye           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_threat_var(char *format_string, va_list *args, int *pt_count)
{
	...
	*pt_count = ft_print_var(&flags, args, 1);
	widthadd = flags.width - *pt_count;
	...
	*pt_count = ft_print_var(&flags, &argscopy, 0) + widthadd;
